...
public class HttpClientUtil {
	...
	private static void enableSSL(DefaultHttpClient httpclient) {
		...
		try {
			...
			e.printStackTrace();
			logger.error("访问https的网站:"+e.getMessage());
		}
	}
	...
	public static String postJson(String url, String json) {
		...
		try {
			...
			e.printStackTrace();
			logger.error("postJson:"+e.getMessage());
		}
		return responseStr;
	...
	public static String postXml(String url, String xml) {
		...
		try {
			...
			e.printStackTrace();
			logger.error("postXml:"+e.getMessage());
		}
		return responseStr;
	}
	...
	public static String postXmlBySSL(String url, String xml, String certPath, String certSecret) {
		...
		try {
			...
			SSLConnectionSocketFactory sslfs = new SSLConnectionSocketFactory(sslContext, new String[] { "TLSv1" },
			...
			if (instream != null) {
				try {
					...
					e.printStackTrace();
					logger.error("post请求:"+e.getMessage());
				}
			}
		}
		return responseStr;
	...
	public static String httpRequest(String url, List<NameValuePair> paramsList, String method, HttpHost proxy) {
		...
		try {
			...
			e.printStackTrace();
			logger.error("提交数据到服务器:"+e.getMessage());
		} 
		return responseStr;
	}
	...
	public static String httpFileRequest(String url, Map<String, String> fileMap, Map<String, String> stringMap,
		...
		try {
			...
			e.printStackTrace();
			logger.error("httpFileRequest:"+e.getMessage());
		}
		return responseStr;
	}
